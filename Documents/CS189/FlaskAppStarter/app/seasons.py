...
def extractSkin(image):
  ...
  img =  image.copy()
  # Converting from RGB Colours Space to HSV
  img =  cv2.cvtColor(img,cv2.COLOR_RGB2HSV)
  

  # ooh but the input is rgb #TODO: fix this!!
...
#   img = cv2.cvtColor(img,cv2.COLOR_BGR2RGB) #it's already in rgb... #TODO: UNCOMMENT IF THINGS GO WRONG
...
def newwarmorcool(numpyarray):
    ...
    # skincolor = getskincolor(numpyarray)
...
def newclearorsoft(numpyarray):
    ...
    #NOTE: PLotting stuff confuses flask app. 
